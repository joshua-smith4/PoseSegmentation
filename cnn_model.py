...
def cnn_model_fn_keras():
    ...
    print(up1.shape)
    deconv1 = Conv2DTranspose(64, (3,3), activation='relu', padding='same', name='deconv1')(up1)
    print(deconv1.shape)
    deconv2 = Conv2DTranspose(64, (3,3), activation='relu', padding='same', name='deconv2')(deconv1)
    print(deconv2.shape)
