...
dataset = Dataset.from_generator(load_preproc_generator, (tf.float16, tf.uint8), (tf.TensorShape([424,512]), tf.TensorShape([424,512])), args=('/home/jsmith/ubc3v_preproc',))
